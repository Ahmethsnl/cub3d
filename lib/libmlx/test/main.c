...
{
  printf("Mouse in Win1, button %d at %dirx%d.\n",button,x,y);
}

int	mouse_win2(int button,int x,int y, void *p)
{
  printf("Mouse in Win2, button %d at %dirx%d.\n",button,x,y);
}

int	mouse_win3(int x,int y, void *p)
{
  printf("Mouse moving in Win3, at %dirx%d.\n",x,y);
}
...
int	main()
{
  ...
  printf(" => Window1 %dirx%d \"Title 1\" ...",WIN1_SX,WIN1_SY);
  ...
  printf(" => Image1 ZPixmap %dirx%d ...",IM1_SX,IM1_SY);
  ...
  printf(" => Image3 ZPixmap %dirx%d ...",IM3_SX,IM3_SY);
  ...
  printf("OK (xpm %dirx%d)(img bpp2: %d, sizeline2: %d endian: %d type: %d)\n",
